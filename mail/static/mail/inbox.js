...
function display_message(message) {
  ...
  mes_div.classList.add("alert");
  if (message["message"]) {
    mes_div.classList.add("alert-success");
    mes_div.innerHTML = message["message"];
  } else if (message["error"]) {
    mes_div.classList.add("alert-danger");
    mes_div.innerHTML = message["error"];
  }
  document.querySelector("#error-message").appendChild(mes_div);
}
